...
document.addEventListener('DOMContentLoaded', function() {
    const greetingContainer = document.querySelector('.greeting-text');
    const text = greetingContainer.textContent.trim();
    ...
    function typeNextWord() {
        if (wordIndex < words.length) {
            ...
            greetingContainer.innerHTML = currentText;
            wordIndex++;
